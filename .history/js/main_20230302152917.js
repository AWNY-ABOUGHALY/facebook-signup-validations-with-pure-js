...
yearCheck && yearCheck.addEventListener('click',()=>{
    if(dayCheck.value === "" || monthCheck.value === "" || yearCheck.value === "") {
        selectLabl.innerHTML = "Please Select Your Birth Day";
        selectLabl.style.color = "orange"
...
dayCheck && dayCheck.addEventListener('click',()=>{
    if(dayCheck.value === "" || monthCheck.value === "" || yearCheck.value === "") {
        selectLabl.innerHTML = "Please Select Your Birth Day";
        selectLabl.style.color = "orange"
        return (valid = false);
...
monthCheck && monthCheck.addEventListener('click',()=>{
    if(dayCheck.value === "" || monthCheck.value === "" || yearCheck.value === "") {
        selectLabl.innerHTML = "Please Select Your Birth Day";
        selectLabl.style.color = "orange"
        return (valid = false);
...
gMale && gMale.addEventListener('click',()=>{
    genderLabl.innerHTML = "Gender";
    genderLabl.style.color = "#1877f2"
    genderMark.style.display = "inline-block"
})
gFemale && gFemale.addEventListener('click',()=>{
    genderLabl.innerHTML = "Gender";
    genderLabl.style.color = "#1877f2"
    genderMark.style.display = "inline-block"
})
