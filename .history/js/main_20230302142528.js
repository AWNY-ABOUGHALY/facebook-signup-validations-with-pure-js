...
let awny = [
    {att: showFstName, query: '.showfname', att2: myInfoIcon, query2: '.info1'},
]
awny.map((e)=>{
    return (
        console.log("good"),
        let [e.att] = document.querySelector(e.query),
        let [e.att2] = document.querySelector(e.query2),
        e.att2.addEventListener('click',()=>{
            if(e.att.style.display === "none") {
                e.att.style.display = "inline-block"
            } else {
                e.att.style.display = "none"
            }
        })
    )
})
...
//     if(showFstName.style.display === "none") {
//         showFstName.style.display = "inline-block"
//     } else {
//         showFstName.style.display = "none"
//     }
// })
...
myInfo2Icon.addEventListener('click',()=>{
    if(showLstName.style.display === "none") {
        showLstName.style.display = "inline-block"
    } else {
        showLstName.style.display = "none"
    }
})
...
myInfo3Icon.addEventListener('click',()=>{
    if(showEmAdrs.style.display === "none") {
        showEmAdrs.style.display = "inline-block"
    } else {
        showEmAdrs.style.display = "none"
    }
})
...
myInfo4Icon.addEventListener('click',()=>{
    if(showMoNmbr.style.display === "none") {
        showMoNmbr.style.display = "inline-block"
    } else {
        showMoNmbr.style.display = "none"
    }
})
...
myInfo5Icon.addEventListener('click',()=>{
    if(showNePass.style.display === "none") {
        showNePass.style.display = "inline-block"
    } else {
        showNePass.style.display = "none"
    }
})
...
myInfo6Icon.addEventListener('click',()=>{
    if(showCoPass.style.display === "none") {
        showCoPass.style.display = "inline-block"
    } else {
        showCoPass.style.display = "none"
    }
})
